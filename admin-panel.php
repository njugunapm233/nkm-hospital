...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> NORTH KINANGOP MISSION HOSPITAL</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> North Kinangop Hospital </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #6f6d83, #994626);
}
